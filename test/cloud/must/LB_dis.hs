                 ...
                 (do I__.writeRef dc
                       (IDC <$!>
                          (I__.join
                             (I__.new_local <$!>
                                (pure __localDC <*>
                                   ((+) <$!> pure 9000 <*> (I__.fromIntegral <$!> I__.readRef i)))
                                  <*> pure this)))
                     I__.writeRef dcs
                           ...
                           \ S{s_b = __b} ->
                             (I__.join
                                ((\ __wrap@(Balancer
                                   ...
                                   <$!> (pure (I__.up __b)))))
                        return ())
               res :: I__.IORef Res <- I__.newRef (pure 3)
               (I__.readThis this >>=
                  \ S{s_b = __b} ->
                    (I__.join
                       ((\ __wrap@(Balancer
