          ...
          = do i :: I__.IORef Int <- I__.newRef
               ...
               (I__.readThis this >>=
                  \ B{b_farm = __farm} ->
                    (I__.join
                       (I__.new <$!>
                          (pure __heartbeater <*> (pure __farm) <*> pure (I__.up this)))))
               return ()
...
data Heartbeater = Heartbeater{heartbeater_b :: Balancer,
                               heartbeater_farm :: List Server}
                 deriving (I__.Typeable, I__.Generic)
__heartbeater farm b
  = Heartbeater{heartbeater_b = b, heartbeater_farm = farm}
                             ...
                             I__.writeRef r
                               (I__.readThis this >>=
                                  \ Heartbeater{heartbeater_farm = __farm} ->
                                    ((/) <$!> ((I__.readRef sum)) <*>
                                       ((pure length <*> (pure __farm)))))
                             ifthenM
                               ((>) <$!> ((I__.readRef r)) <*> ((/) <$!> pure 80 <*> pure 100))
                               (do do println (pure "needs bigger")
                                      I__.writeRef dc
                                        (IDC <$!>
                                           (I__.join
                                              (I__.new <$!>
                                                 (pure __nebulaDC <*> pure 1 <*> pure 8192))))
                                      I__.writeRef s
                                        (Server <$!>
                                           I__.join
                                             ((\ (IDC __dc) ->
                                                 (I__.join (spawns <$!> (pure __server))) __dc)
                                                <$!> ((I__.up <$!> I__.readRef dc))))
                                      (I__.join
                                         (I__.set 1 (\ v__ c__ -> c__{heartbeater_farm = v__}) <$!>
                                            (I__.readThis this >>=
                                               \ Heartbeater{heartbeater_farm = __farm} ->
                                                 ((:) <$!> ((I__.up <$!> I__.readRef s)) <*>
                                                    (pure __farm)))
                                              <*> pure this))
                                      (I__.readThis this >>=
                                         \ Heartbeater{heartbeater_b = __b} ->
                                           (I__.join
                                              ((\ __wrap@(Balancer
                                                            __obj@(I__.ObjectRef _
                                                                     (I__.COG (_, __pid)) _))
                                                  ->
                                                  if I__.processNodeId __pid == I__.myNodeId then
                                                    I__.join
                                                    ...
                                                    do __args <- (,) <$!>
                                                                   ((I__.up <$!> I__.readRef s)) <*>
                                                                     pure __wrap
                                                       (^@@) this __obj
                                                         ($( I__.mkClosure 'addToFarm__remote )
                                                            __args))
                                                 <$!> (pure (I__.up __b)))))
                                      return ())
                             I__.liftIO (I__.join ((pure threadDelay <*> pure 60000000)))
                             return ())
                       return ()
                  ...
                  \ S{s_b = __b} ->
                    (I__.join
                       ((\ __wrap@(Balancer
                          ...
                          <$!> (pure (I__.up __b)))))
               return ()
        server_load this = do ((/) <$!> pure 9 <*> pure 10)
